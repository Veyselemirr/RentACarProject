...
namespace RentACarPersistence.Migrations
{
    ...
    [Migration("20250111021431_mig_feature_update")]
    partial class mig_feature_update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentACarDomain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("RentACarDomain.Entities.RentACarProcess", b =>
                {
            ...
            modelBuilder.Entity("RentACarDomain.Entities.RentaCar", b =>
                {
            ...
            modelBuilder.Entity("RentACarDomain.Entities.Reservation", b =>
                {
            ...
            modelBuilder.Entity("RentACarDomain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.HasOne("RentACarDomain.Entities.Customer", "Customer")
                        .WithMany("RentACarProcesses")
            ...
            modelBuilder.Entity("RentACarDomain.Entities.RentaCar", b =>
                {
                    ...
                    b.HasOne("RentACarDomain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("RentACarDomain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("RentACarDomain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservation")
                        .HasForeignKey("DropOffLocationID");

                    b.HasOne("RentACarDomain.Entities.Location", "PickUpLocation")
